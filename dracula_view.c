...
void dv_get_locale_info(dracula_view *dv, location_t where, int *n_traps,
                        int *n_vamps) {//TODO traps and vampire tracking can be done in gameview in second part of assignment
//TODO TEST
...
//function to take the index of a trail move and determine the round that move was made in
